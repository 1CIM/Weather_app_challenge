        ...
        <Container data-cy="weather-display" fluid>
          <Header as="h1" textAlign="center" id="head">
            <Header.Content data-cy="location">
              <Icon size="large" name="building outline" />
              {city}
            </Header.Content>
          </Header>
          <Segment float id="opaci">
            <Grid verticalAlign="middle" columns={4} centered textAlign="left">
              <Grid.Row>
                <Grid.Column>
                  <Header textAlign="center" data-cy="temp">
                    <Icon size="large" name="thermometer full" />
                    {temp}°C
                  </Header>
                </Grid.Column>
                <Grid.Column>
                  <Header textAlign="center" data-cy="today">
                    Today
                  </Header>
                  <br />
                  <Header textAlign="center" data-cy="timezone">
                    <Icon size="large" name="world" />
                    Time Zone: {timezone}
                  </Header>
                </Grid.Column>
                <Grid.Column>
                  <Header textAlign="center" data-cy="weather-type">
                    {" "}
